...
"raster, brick, stack",   "rast", NA, # elevated due to primacy
       "rasterFromXYZ",  "rast(, type='xyz')", NA,
"stack, addLayer", "c", NA,
"addLayer", "add<-", NA,
...
"couldBeLonLat", "is.lonlat", NA,
                "crop",        "crop", "no behaviour change flagged in terra package notes",
...
"reclassify, subs, cut", "classify", NA,
            "resample",    "resample", "no behaviour change flagged in terra package notes",
